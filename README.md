...
| `AI_HISTORY_MESSAGES` | Past chat messages sent to the model (overridable per connection) | `20` |
| `AI_MAX_PROMPT_TOKENS` | Prompt budget in estimated tokens; oldest messages are dropped beyond it (overridable per connection) | `60000` |
